...
Use simple language. No jargon. Like explaining to a friend.`
        ...
        res.json({
            strategy: name,
            explanation: `Your ${name} strategy had a win rate of ${win_rate}% which means it lost more trades than it won. The worst period was ${worst_month} with a max drawdown of ${drawdown}%. Add credits to get full AI analysis.`
        })
    }
})
